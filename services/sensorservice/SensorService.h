...
private:
    ...
    // OPLUS fusion light ext: symbols the prebuilt libsensorserviceextimpl.so links
    // against (exported despite -fvisibility=hidden). See OplusFusionExt.cpp.
    ...
    __attribute__((visibility("default"))) void setSensorStateForTemporarily(int handle,
                                                                             bool shouldEnable);
